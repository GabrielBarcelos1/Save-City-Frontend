...
export const AiOutlineArrowUpStyled = styled(AiOutlineArrowUp)`
...
`;
export const ContainerLeftSearchEmpty = styled.div`
  width: 50%;
  height: 100%;
...
export const H1ContainerLeft = styled.h1`
  ...
  font-weight: 700;
`;
export const H1ContainerSearchEmpty = styled.h1`
  color: #58af9c;
  font-weight: 700;
`;
export const TextContainerLeft = styled.p`
  ...
  max-width: 40%;
`;
export const TextContainerSaerchEmpty = styled.p`
  color: #95d1c7;
  line-height: 30px;
  max-width: 80%;
`;
